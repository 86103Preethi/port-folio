...
const Contact = () => {
  return (
   <div name="contact" className='min-h-screen bg-black flex justify-center items-center text-center px-5'>
         <form action='https://getform.io/f/01030412-91bd-46d3-a903-d840fd5c2075' method="POST" className='flex flex-col w-full max-w-[700px]'>
            <div className='w-full mx-auto'>
               <p className='text-5xl font-bold inline border-b-4 border-[#c76acb] text-[#ccd6f6]'>Contact</p>
               <p className='text-[#d1d5db] py-6 md:text-xl'>Submit the form below or shoot me an email - @preethis835@gmail.com </p>
            </div>
